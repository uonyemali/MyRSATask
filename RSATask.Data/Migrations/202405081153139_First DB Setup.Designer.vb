...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FirstDBSetup
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FirstDBSetup))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202405081153139_First DB Setup"
            End Get
        End Property
